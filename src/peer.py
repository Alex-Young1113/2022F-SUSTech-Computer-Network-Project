...
def process_sender(sock: simsocket.SimSocket, from_addr, Type, data, plen, Ack):
    ...
    if Type == 0:
        ...
        flag = False  # if the chunk is smaller than 5 pkt, break
        ...
        if smallest_ack == ack_num:
            ...
            estimated_rtt, dev_rtt, timeout_interval = estimated_rtt_dict[
                key], dev_rtt_dict[key], timeout_interval_dict[key]
            ...
            if start_time != -1:
                ...
                estimated_rtt_dict[key], dev_rtt_dict[key], timeout_interval_dict[
                    key] = estimated_rtt, dev_rtt, timeout_interval
            ...
            if (ack_num) * MAX_PAYLOAD >= CHUNK_DATA_SIZE:
                ...
                for seq_num in range(ack_num + 1, ack_num + 6):
                    ...
                    if flag:
                        break
        smallest_ack_dict[key], biggest_ack_dict[key], redundant_ack_dict[
            key] = smallest_ack, biggest_ack, redundant_ack
